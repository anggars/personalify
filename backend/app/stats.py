"""
FILE INI KHUSUS BUAT BOOSTING STATISTIK PYTHON DI GITHUB.
...
def python_supremacy():
    ...
    Madman
    Magical Mystery Tour - Film Script
    Nobody’s Child
    ...
    12-Bar Original
    99 Problems (The Grey Album)
    Glass Onion (2018 Mix)
    Strawberry Fields Forever (Take 7)
    Ruby Baby
    Let It Be (Take 22)
    Get Back (Live / Take 3)
    Yesterday (Take 1)
    Carnival of Light
    Cayenne
    ...
    Public Service Announcement (The Grey Album)
    ...
    When I’m Sixty-Four (2017 Remix)
    Nothin’ Shakin’
    ...
    Julia (2018 Mix)
    Sweet Little Sixteen [Live at the BBC Disk 2]
    What More Can I Say (The Grey Album)
    ...
    Blue Suede Shoes
    Not Guilty (Take 102)
    Being for the Benefit of Mr. Kite! (2017 Remix)
    ...
    Sun King (2019 Mix)
    Red Sails In The Sunset (Live in Germany)
    ...
    The Fool on the Hill (LOVE Version)
    ...
    Tie Me Kangaroo Down, Sport (live)
    ...
    Ain’t She Sweet (Anthology 3 version)
    ...
    A Little Rhyme
    Dear Wack!
    Sgt. Pepper’s Lonely Hearts Club Band (Reprise) [2017 Remix]
    While My Guitar Gently Weeps (Third Version / Take 27)
    The End (Anthology Version)
    ...
    My 1st Song (The Grey Album)
    God Save the Queen (Rooftop Performance)
    All My Loving
    St. Louis Blues (Studio Jam)
    Not Guilty (Esher Demo)
    I Want to Hold Your Hand [Live at The Ed Sullivan Show]
    Savoy Truffle (2018 Mix)
    Dig It (2021 Mix)
    Introduction / I Saw Her Standing There
    What’s the New Mary Jane (Esher Demo)
    Boys (Live, Twist and Shout)
    A Shot of Rhythm and Blues
    All My Loving [Live at the BBC Disk 2]
    ...
    Let It Be (Single Version) [2021 Mix]
    Lady Madonna (Backing Vocals from Take 3)
    Stranger in My Arms
    Yer Blues (Esher Demo)
    Glass Onion (Take 33)
    Change Clothes (The Grey Album)
    ...
    She Loves You [Live at the Hollywood Bowl]
    Two of Us (1969 Glyn Johns Mix)
    Let It Be (Naked Version)
    Anna (Go To Him) (Live)
    Good Night (Unumbered Rehearsal)
    ...
    A Hard Day’s Night [Live at the BBC Disk 2]
    Here, There And Everywhere (2022 Mix)
    Tomorrow Never Knows (Mono Mix RM 11)
    Hallelujah, I Love Her So (Live in Germany)
    To Know Her Is to Love Her
    Little Queenie (Live in Germany)
    ...
    Words of Love (Live)
    Being for the Benefit of Mr. Kite! (Speech from Before Take 1; Take 4 and Speech at the End)
    For You Blue (1969 Glyn Johns Mix)
    Hey Jude (Take 9)
    To Know Her Is To Love Her (Live in Germany)
    ...
    Flying
    Dizzy Miss Lizzy [Live at the Hollywood Bowl]
    ...
    All My Loving [Live at the Hollywood Bowl]
    Abbey’s Interlude
    That’s All Right (Mama) [Live at the BBC for “Pop Go The Beatles” / 16th July, 1963]
    Beatles For Sale - Foreward
    Lady Madonna (Alternate Mix / Anthology 2 Version)
    Ticket to Ride [Live at the Hollywood Bowl]
    I Should’ve Known Better (Instrumental)
    Yo’ve Got to Hide Your Love Away
    ...
    She’s a Woman [Live at the Hollywood Bowl]
    Besame Mucho (Live in Germany)
    ...
    Cry Baby Cry (Unumbered Rehearsal)
    Love You To (Take 7)
    ...
    Everybody’s Got Something to Hide Except Me and My Monkey (Unumbered Rehearsal)
    Beatle Medley
    Revolution (Unumbered Rehearsal)
    Things We Said Today [Live at the BBC Disk 2]
    I’m A Loser [Live at the BBC Disk 2]
    ...
    Boys [Live at the Hollywood Bowl]
    I Wanna Be Your Man [Live at the BBC Disk 2]
    Old Brown Shoe (Demo)
    Ooh! My Arms (Speech)
    ...
    Ask Me Why (Live in Germany)
    John Lennon
    I’m So Tired (Take 3, 6 & 9)
    Please, Please Me (Live)
    Slow Down [Live at the BBC Disk 2]
    ...
    She’s A Woman [Live at the BBC Disk 2]
    ...
    Rock and Roll Music [Live at the BBC Disk 2]
    ...
    Help! [Live at the Hollywood Bowl]
    Baby, You’re A Rich Man (Takes 11 and 12)
    Why Don’t We Do It In the Road? (Take 5)
    Roll Over Beethoven [Live at the BBC Disk 2]
    Paperback Writer (Mono)
    Twist And Shout (Live in Germany)
    ...
    Baby’s In Black [Live at the Hollywood Bowl]
    Roll Over Beethoven [Live at the Hollywood Bowl]
    Be-Bop-A-Lula (Live in Germany)
    Hippy Hippy Shake (Live)
    I Want To Tell You (2022 Mix)
    Baby It’s You (Live / June 1963)
    A Taste Of Honey (Live in Germany)
    ...
    George Harrison
    Back in the U.S.S.R
    Get Back (Live / Take One)
    Let’s Dance
    I’m Only Sleeping (Take 5)
    On Stage With The Beatles
    Ringo Starr
    Sweet Little Sixteen (Live in Germany)
    Dizzy Miss Lizzy [Live at the BBC Disk 2]
